...
public class GDXRoot extends Game implements ScreenListener {
	...
	public void create() {
		...
		controllers[18] = new GameplayController("jsons/timedstun.json");
		controllers[19] = new GameplayController("jsons/simultrap.json");
		controllers[20] = new GameplayController("jsons/spinstun.json");
		controllers[21] = new GameplayController("jsons/blockedpaths.json");
