...
import edu.cornell.gdiac.rekindled.*;  // For GameCanvas
 ...
 */
public class FeetHitboxObstacle extends SimpleObstacle {
     ...
     */
    public FeetHitboxObstacle(float width, float height) {
     ...
     * @param height	The object width in physics units
     */
    public FeetHitboxObstacle(float x, float y, float width, float height) {
     ...
     * @param height	The object width in physics units
     */
    public FeetHitboxObstacle(float x, float y, float width, float height, Orientation o) {
        super(x,y);
